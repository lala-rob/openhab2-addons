...
public abstract class AbstractBulbInterface {
    ...
    public abstract void setAnimationSpeed(int speed, MilightThingState state);
    ...
    public static final int CAT_NIGHTMODE1 = 15;
    public static final int CAT_NIGHTMODE2 = 16;
     ...
     */
    public AbstractBulbInterface(QueuedSend sendQueue, int zone) {
     ...
     * category.
     *
     * @param bulb_type The bulb type offset
     * @param command_category The category of the command.
     * @return
     */
    protected int uidc(int bulb_type, int command_category) {
        return (zone + bulb_type + 1) * 64 + command_category;
    }
}