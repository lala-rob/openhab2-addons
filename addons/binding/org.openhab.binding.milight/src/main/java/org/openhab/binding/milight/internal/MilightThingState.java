...
public class MilightThingState {
    public int animationSpeed = 0, ledMode = 0;

    public int colorTemperature = 0; // only for led bulbs which include white leds applicable
    public int brightness = 100;
    public float hue = 0.5f; // only for rgb(w) leds applicable (v3+)
